<template>
   <div id="view-employee">
       ...
       <!-- <input type="text"> -->
       <router-link  to="/" class="btn blue collection-item"> Done </router-link>
       <router-link to="/" class="btn grey"> Back </router-link>
       <!-- <button @click="deleteEmployee" class="btn red"> Delete </button> -->
       
      <div class="fixed-action-btn">
      <!-- <router-link v-bind:to="{ name: 'edit-employee', params: { peg: peg }}" class="btn-floating btn-large red">
